            ...
            private void handleAddEdge(MouseEvent mouseEvent) {
                ...
                if (clickedVertex1 == null) {
                    ...
                    if (clickedVertex2 != null) {
                        ...
                        addEdge(clickedVertex2.getId(), clickedVertex1.getId(), clickedVertex1.getRectX(), clickedVertex1.getRectY(), clickedVertex2.getRectX(), clickedVertex2.getRectY()).setVisible(false);
                        setVisible(true);
